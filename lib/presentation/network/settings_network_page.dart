...
class _SettingsNetworkPageState extends State<SettingsNetworkPage> {
  ...
  String _privacyLevel = 'public'; // public, connections, private
  bool _loading = true;
  ...
  Future<void> _loadSettings() async {
    try {
      ...
      if (userId != null) {
        ...
        if (privacy != null) {
          setState(() {
            _privacyLevel = privacy['profile_visibility'] ?? 'public';
          });
        }
      }
    } catch (e) {
  ...
  void _showDeleteAccountDialog() {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: const Text('Cette action est irréversible. Toutes vos données seront supprimées. Confirmez-vous ?'),
        actions: [
