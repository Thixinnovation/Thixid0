...
class _ReservationHotelsPageState extends State<ReservationHotelsPage> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              const Icon(Icons.location_on, size: 20, color: Color(0xFFD4AF37)),
              ...
              Expanded(
                child: DropdownButtonFormField<String>(
                  ...
                  items: const [
                    DropdownMenuItem(value: 'Abidjan, Côte d\'Ivoire', child: Text('Abidjan, Côte d\'Ivoire')),
                    DropdownMenuItem(value: 'Dakar, Sénégal', child: Text('Dakar, Sénégal')),
                    DropdownMenuItem(value: 'Paris, France', child: Text('Paris, France')),
                    DropdownMenuItem(value: 'Dubai, UAE', child: Text('Dubai, UAE')),
                  ],
  ...
  Widget _buildDateRow() {
    return Row(
      children: [
        Expanded(
          child: _buildDateField('Arrivée', _arrivee, (date) => setState(() => _arrivee = date)),
        ),
        const SizedBox(width: 12),
        Expanded(
          child: _buildDateField('Départ', _depart, (date) => setState(() => _depart = date)),
        ),
      ],
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: _buildCounter('Chambres', _chambres, (val) => setState(() => _chambres = val), 1, 10),
              ),
              const SizedBox(width: 16),
              Expanded(
                child: _buildCounter('Adultes', _adultes, (val) => setState(() => _adultes = val), 1, 20),
              ),
            ],
          ),
        ],
  ...
  Widget _buildOffresMoment() {
    final offres = [
      ...
      {'nom': 'Pullman Hôtel Paris', 'prixOriginal': '220€', 'prixPromo': '198€', 'note': '4.6', 'ville': 'Paris'},
    ];
    return SizedBox(
      height: 180,
      child: ListView.builder(
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Text('${offre['prixOriginal']!} FCFA', style: const TextStyle(decoration: TextDecoration.lineThrough, fontSize: 10, color: Colors.grey)),
                          const SizedBox(width: 8),
                          Text('${offre['prixPromo']!} FCFA', style: const TextStyle(fontWeight: FontWeight.bold, color: Color(0xFFD4AF37), fontSize: 12)),
                        ],
                      ),
                    ],
                  ),
